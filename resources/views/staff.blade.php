<x-layout title="{{__('ui.staff')}}">

    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-md-4 d-flex justify-content-center">
                
                <div class="a-box my-5">
                    <div class="img-container">
                      <div class="img-inner">
                        <div class="inner-skew">
                          <img src="/media/staff/fabio.jpg">
                        </div>
                      </div>
                    </div>
            ...
            <div class="col-12 col-md-4 d-flex justify-content-center">  
                <div class="a-box my-5">
                    <div class="img-container">
                      <div class="img-inner">
                        <div class="inner-skew">
                          <img src="/media/staff/Manuel.jpg">
                        </div>
                      </div>
                    </div>
                    <div class="text-container d-flex flex-column justify-content-evenly">
                    ...
                    <div class="my-2">
                        <a href="linkedin.com/in/manuel-tedeschi-junior-developer"><i class="fa-brands fa-linkedin fa-2x color-prim mx-2"></i></a>
                        <a href="https://github.com/9Manuel6?tab=repositories"><i class="fa-brands fa-github fa-2x color-prim mx-2"></i></a>
                    </div>
                  </div>
                </div>
            </div>
            <div class="col-12 col-md-4 d-flex justify-content-center">
                <div class="a-box my-5">
                    <div class="img-container">
                      <div class="img-inner">
                        <div class="inner-skew">
                          <img src="/media/staff/Francesca.png">
                        </div>
                      </div>
                    </div>
                    <div class="text-container d-flex flex-column justify-content-evenly">
            ...
            <div class="col-12 col-md-4 d-flex justify-content-center">
                <div class="a-box my-5">
                    <div class="img-container">
                      <div class="img-inner">
                        <div class="inner-skew">
                          <img src="/media/staff/Francesco.jpg">
                        </div>
                      </div>
                    </div>
                    <div class="text-container d-flex flex-column justify-content-evenly">
            ...
            <div class="col-12 col-md-4 d-flex justify-content-center">
                <div class="a-box my-5">
                    <div class="img-container">
                      <div class="img-inner">
                        <div class="inner-skew">
                          <img src="/media/staff/Roberto.jpg">
                        </div>
                      </div>
                    </div>
                    <div class="text-container d-flex flex-column justify-content-evenly">
            ...
            <div class="col-12 col-md-4 d-flex justify-content-center">
                <div class="a-box my-5">
                    <div class="img-container">
                      <div class="img-inner">
                        <div class="inner-skew">
                          <img src="/media/staff/gaetano.jpg">
                        </div>
                      </div>
                    </div>
                    <div class="text-container d-flex flex-column justify-content-evenly">
