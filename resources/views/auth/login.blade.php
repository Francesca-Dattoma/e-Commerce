            ...
            <div class="row full-height justify-content-center align-items-center">
                <div class="col-12 text-center align-self-center py-5">
                    ...
                    <div class="section pb-5 pt-5 pt-sm-2 text-center">
                        ...
                        <span ><h6 class="h6Login h4">Login</h6></span>
                        <input class="checkbox" type="checkbox" id="reg-log" name="reg-log"/>
                        <label for="reg-log"></i></label>
                        <span class="h4"><h6 class="h6Login h4">Registrati</h6></span>
                    ...
                    {{-- Wrapper --}}
                        ...
                        <div class="card-3d-wrap mx-auto">
                            ...
                            {{-- Login --}}
                                <form action="{{route('login')}}" method="POST" class="card-front">
                                    @csrf
                                ...
                                <form class="card-back" action="{{route('register')}}" method="POST">
                                    @csrf
                                    <div class="center-wrap">
                                        <div class="section text-center">
